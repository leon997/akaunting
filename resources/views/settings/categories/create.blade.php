            ...
            <x-form id="category" route="categories.store">
                <x-form.section>
                    ...
                    <x-slot name="body">
                        ...
                        <x-form.group.select name="parent_id" label="{{ trans('general.parent') . ' ' . trans_choice('general.categories', 2) }}" :options="[]" not-required dynamicOptions="categoriesBasedTypes" sort-options="false" v-disabled="selected_type" />
