<div
  ...
  class="fixed w-full lg:w-4/5 h-screen flex items-center justify-center top-0 bottom-0 ltr:right-0 rtl:left-0 -mx-1 z-50"
  style="z-index: 60; background: linear-gradient(to right, #ece9e6, #ffffff);"
>
