...
>
    ...
    <span data-menu-close id="menu-cancel" class="material-icons-outlined text-purple-400 absolute ltr:-right-2 rtl:right-12 transition-all top-8 text-lg cursor-pointer z-10 hidden">cancel</span>
