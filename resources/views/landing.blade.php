...
<head>
  ...
  -->
    ...
    <style>
        ...
        .gradient {
            background-image: url({{ asset('public/img/auth/login-bg.png') }});
        }
...
<nav id="header" class="w-full z-30 top-0 text-white py-1 lg:py-6">
    ...
    >
        ...
        >
            ...
            <button
                id="navAction"
                class="mx-auto lg:mx-0 hover:underline text-white font-extrabold rounded mt-4 lg:mt-0 py-4 px-8"
            >
                Prijava
            </button>
            </a>
...
<div class="container mx-auto h-screen">
    <div class="text-center px-3 lg:px-0">
        ...
        <a href="{{ route('signUp') }}">
        <button
            class="mx-auto lg:mx-0 hover:underline text-white font-extrabold rounded my-2 md:my-6 py-4 px-8 shadow-lg w-60"
        >
            Postanite uporabnik
        </button>
        </a>
